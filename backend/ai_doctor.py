...
def _call_gemini(data: AIDoctorRequest) -> Dict[str, Any]:
    ...
    request_body = {
        ...
        "generationConfig": {
            "temperature": 0.2,
            "maxOutputTokens": 900,
            "responseMimeType": "application/json", "responseSchema": {                         "type": "object",                         "properties": {                             "summary": {"type": "string"},                             "risk_signals": {                                 "type": "array",                                 "items": {                                     "type": "object",                                     "properties": {                                         "title": {"type": "string"},                                         "severity": {"type": "string", "enum": ["info", "watch", "urgent"]},                                         "message": {"type": "string"}                                     },                                     "required": ["title", "severity", "message"]                                 }                             },                             "recommendations": {                                 "type": "array",                                 "items": {                                     "type": "object",                                     "properties": {                                         "title": {"type": "string"},                                         "action": {"type": "string"},                                         "why": {"type": "string"}                                     },                                     "required": ["title", "action", "why"]                                 }                             },                             "next_steps": {"type": "array", "items": {"type": "string"}},                             "disclaimer": {"type": "string"}                         },                         "required": ["summary", "risk_signals", "recommendations", "next_steps", "disclaimer"]                     },
        },
    }
